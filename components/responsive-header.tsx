        ...
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div className="hidden md:block">
              ...
              <div className="text-xs text-muted-foreground">Electronics and Communication Engineer</div>
            </div>
          </div>
  ...
  return (
    ...
    >
      <div className="container flex h-16 items-center justify-between px-4">
        ...
        >
          <div className="flex items-center gap-2">
            <div className="font-bold text-xl pb-3 bg-gradient-to-r from-happy-hearts to-golden-nugget text-transparent bg-clip-text">
              AG
            </div>
            <div className="hidden md:block">
              <div className="font-bold">Abhishek Gond</div>
