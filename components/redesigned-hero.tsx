...
export default function RedesignedHero() {
  ...
  const fullText = "  Crafting seamless web experiences, cracking DSA challenges, and chasing curiosity one line of code at a time."
  ...
  const highlightText = (text: string) => {
    const termsToHighlight = ["DSA", "Web Devlopment", "Graphic Designer"]
        ...
        <div className="order-2 md:order-1 text-center md:text-left">
          ...
          <ScrollReveal delay={0.5}>
            <div className="flex gap-4 justify-center md:justify-start">
              ...
              >
                <a
                  href="https://github.com/ItsAbhishekkashyap"
                  target="_blank"
