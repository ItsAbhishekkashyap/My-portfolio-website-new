      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            >
              ...
              <div className="flex gap-3">
                <SocialButton
                  ...
                  url="https://github.com/ItsAbhishekkashyap"
                  label="GitHub"
                />
                <SocialButton
                ...
                <SocialButton
                  ...
                  url="mailto:abhi47025@gmail.com"
                  label="Email"
                />
              </div>
            </motion.div>
          ...
          <div>
            ...
            >
              <h3 className="font-semibold mb-4">Join My Dev Dojo 🥋</h3>
              <p className="text-muted-foreground mb-4">
                Be the first to know when I drop new web apps, technical blogs, design projects, or even martial arts content. No spam—just real updates.
              </p>
        ...
        <div className="border-t pt-6 flex flex-col md:flex-row justify-between items-center">
          <div className="text-sm text-muted-foreground mb-4 md:mb-0">
            © {currentYear} Abhishek Gond. All rights reserved.
          </div>
