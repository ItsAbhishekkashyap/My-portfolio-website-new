    ...
    <CustomGradientBackground className="min-h-[90vh]">
      ...
      >
        ...
        <div className="container mx-auto px-4 z-10">
          ...
          >
            <TypewriterEffect
              text="A passionate full-stack web developer, dedicated coder, problem solver through DSA, builder of intuitive digital experiences, always curious, constantly learning, driven to explore new technologies and ideas every day"
              highlightTerms={["Web Developer", "DSA", "Graphic Designer"]}
            />
          </motion.p>
